...
<header class="flex-shrink-0">
    <nav class="navbar navbar-expand-md navbar-dark bg-dark px-3">
        <a class="navbar-brand" href="https://nameless-badlands-15518.herokuapp.com">Анализатор страниц</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="https://nameless-badlands-15518.herokuapp.com/urls">Сайты</a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    <div class="container-lg mt-3">
        <div class="row">
            <div class="col-12 col-md-10 col-lg-8 mx-auto border rounded-3 bg-light p-5">
                ...
                <form action="https://nameless-badlands-15518.herokuapp.com/urls" method="post" class="d-flex justify-content-center">
